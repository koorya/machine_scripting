...
namespace json_converter
{
	public partial class JsonConverter  
	{
		...
		static public string ndarray2base64(Mat img) //проверил, конечная строка сошлась с той, которую получал функцией на питоне
		{
			byte[] im_arr1;
	...
	// # decode from base64 to ndarray
		static public Mat base642ndarray(string str)
		{
			var im_b64 = str;
